...
This coursework is based largely on the OSSU computer science curriculum. I have modified it to reflect my previous undergraduate degree in statistics and my interests. See the original here for more information: [OSSU Computer Science](https://github.com/ossu/computer-science)
...
Courses | Duration | Effort | Prerequisites | Completion Status
:-- | :--: | :--: | :--: | :--:
[CS50's Introduction to Computer Science](https://www.edx.org/course/introduction-computer-science-harvardx-cs50x) | 9 weeks | 15 hours/week | [high school algebra](https://www.khanacademy.org/math/algebra-home) | Not Started
...
### Core math
With my background, I have taken significant mathematics background courses. I am choosing to take a mathematics for CS course and linear algebra as a refresher (I took this as part of my undergraduate degree).
...
This is a list of potential electives that I plan to take. This list will change as I develop specific interests and does not necessarily represent courses I will take or an exhaustive list of options.
...
[Functional Programming in Scala](https://www.coursera.org/specializations/scala#courses)| 14 weeks | - | -
...
[Big Data](https://www.coursera.org/specializations/big-data) | 30 weeks | 3-5 hours/week | none
[Cloud Computing Applications 1](https://www.coursera.org/learn/cloud-applications-part1?specialization=cloud-computing)
[Cloud Computing Applications 2](https://www.coursera.org/learn/cloud-applications-part2?specialization=cloud-computing)
...
[Computer Architecture](https://www.coursera.org/learn/comparch#syllabus) | | |
...
[Approximation Algorithms Part I](https://www.coursera.org/learn/approximation-algorithms-part-1#about)
...
I will complete a large-scale final project that will be determined at a later date based on my interests.
